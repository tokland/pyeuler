...
def problem28():
    ...
    increments = flatten(repeat(n, 4) for n in xrange(2, 1001, 2))
    return sum(ireduce(operator.add, increments, 1))
  
def problem29():
    """How many distinct terms are in the sequence generated by a**b for 
    2 <= a <= 100 and 2 <= b <= 100?"""
    return iterlen(unique(a**b for a in xrange(2, 101) for b in xrange(2, 101)))
